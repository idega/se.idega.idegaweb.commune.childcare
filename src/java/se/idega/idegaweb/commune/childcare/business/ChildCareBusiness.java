...
public interface ChildCareBusiness extends IBOService, CaseBusiness,
	 ...
	 */
	public boolean insertApplications(User user, int[] provider,
			String[] dates, String message, Time fromTime, Time toTime,
			int checkId, int childId, String subject, String body,
			boolean freetimeApplication, boolean sendMessages,
			Date[] queueDates, boolean[] hasPriority)
			throws java.rmi.RemoteException;
	 ...
	 */
	public ChildCareContract getChildCareContractBySchoolClassMember(
			SchoolClassMember member) throws java.rmi.RemoteException;
	 ...
	 */
	public void storeChildCareInformation(User child, boolean canDisplayImage,
			String otherAfterSchoolCareInformation, boolean multiLanguageHome,
	 ...
	 */
	public void storeCustodianInformation(User custodian, boolean hasStudies,
			String studies, Date studyStart, Date studyEnd)
			throws java.rmi.RemoteException;
